...
[assembly: Xamarin.Forms.Dependency(typeof(ShoppingCart.Services.MockDataStore))]
namespace ShoppingCart.Services
{
    public class MockDataStore : IDataStore<Item>
    {
        ...
        public MockDataStore()
        {
            ...
            {
                new Item { Id = Guid.NewGuid().ToString(), Text = "First item", Description="This is an item description.", ImageUrl = "http://via.placeholder.com/256x256", Quantity = 5},
                new Item { Id = Guid.NewGuid().ToString(), Text = "Second item", Description="This is an item description.", ImageUrl = "http://via.placeholder.com/256x256", Quantity = 5 },
